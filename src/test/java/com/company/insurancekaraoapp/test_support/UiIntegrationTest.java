package com.company.insurancekaraoapp.test_support;

import com.company.insurancekaraoapp.InsuranceKaraoAppApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.insurancekaraoapp.screen")
@ContextConfiguration(classes = {InsuranceKaraoAppApplication.class, UiTestAssistConfiguration.class})
